...
engine = create_engine('mysql+pymysql://zhang:Zhang1988@124.71.83.147/wq_rs?charset=utf8')
...
if uploaded_file is not None:
    ...
    db = pymysql.connect(host="124.71.83.147", user="zhang", password="Zhang1988", database="wq_rs", charset="utf8")
